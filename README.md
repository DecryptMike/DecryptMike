...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Orbitron&size=38&letterSpacing=4px&pause=1000&color=72EC54&center=true&width=1100&height=55&lines=...+Cybersecurity;...+Computer+Programmer;...+Website+%26+Software+Development;...+AI+Engineer+)](https://git.io/typing-svg)
...
### Programming
```
- Languages - Python (Advanced), JavaScript (Advanced), Java (Intermediate), C++ (Intermediate), Go (Basic)
              Rust (Basic)
